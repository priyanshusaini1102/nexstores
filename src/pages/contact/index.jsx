...
<div className="container my-24 px-6 mx-auto">
  ...
  <section className="mb-32 ">
    ...
    <div className="container text-white px-4 md:px-12">
      <div className="block rounded-lg shadow-lg shadow-violet-400 py-10 md:py-12 px-2 md:px-6"
        style={{marginTop: '-100px', background: 'hsla(0, 0%, 100%, 0)', backdropFilter: 'blur(30px)'}}>
          ...
          <div className="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0">
            <form>
              <div className="form-group mb-6">
                ...
                font-light 
                m-0
                shadow-inner shadow-violet-400
               focus:border-violet-600 focus:outline-none" 
               style={{background: 'hsla(0, 0%, 100%, 0)'}}
                id="exampleInput7"
                placeholder="Name"/>
              </div>
              <div className="form-group mb-6">
                ...
                transition
                ease-in-out
                m-0 focus:border-violet-600 focus:outline-none
                shadow-inner shadow-violet-400"
               style={{background: 'hsla(0, 0%, 100%, 0)'}}
               id="exampleInput8"
              ...
              <div className="form-group form-check text-center mb-6">
                ...
                <label className="form-check-label inline-block " for="exampleCheck87">Send me a copy of this
                  message</label>
              </div>
